          ...
          output: [
            {
              ...
              content: [
                {
                  type: "output_text",
                  text: "Bu bir test masalıdır. Uzuuun ve yeterince içerik içeren güvenli masal metni.",
                },
              ],
            },
          ],
          ...
          choices: [
            {
              message: {
                content:
                  "Test masalı içerik cümleleri burada. Yeterli uzunlukta bir masal metni.",
              },
            },
          ],
        },
...
describe("Backend basic endpoints", () => {
  ...
  it("POST /api/stories creates a story", async () => {
    const storyText =
      "Bir zamanlar küçük bir test tavşanı vardı ve uzun bir masal anlatılır... ".repeat(
        2,
      );
