...
export const normalizeStory = (story: any): Story => {
  return {
    ...
    customTopic:
      story.customTopic !== undefined ? story.customTopic : story.custom_topic,
    custom_topic:
      story.custom_topic !== undefined ? story.custom_topic : story.customTopic,
    ...
    isFavorite:
      typeof story.is_favorite === "boolean"
        ? story.is_favorite
        : Boolean(story.is_favorite),
