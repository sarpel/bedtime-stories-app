...
export const WakeWordStatus: React.FC<WakeWordStatusProps> = ({
  ...
  const isPlatformError = error && error.includes('Platform compatibility error');
    ...
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm text-gray-700">Wake word detection is disabled</span>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-medium text-amber-800">Wake Word Platform Issue</h4>
            <p className="text-sm text-amber-700 mt-1">
              The wake word model file was created for a different platform.
              Voice recognition will work, but you'll need to manually start listening.
            </p>
              ...
              <div className="text-sm text-amber-700">
                ...
                <ol className="list-decimal list-inside mt-1 space-y-1">
                  <li>Visit <a
                    ...
                    >
                      Picovoice Console <ExternalLink className="h-3 w-3 ml-1" />
                    </a>
                  </li>
                  <li>Create a new "Hey Elsa" wake word</li>
                  <li><strong>Select "Web (WASM)" as the platform</strong></li>
    ...
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-4">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-medium text-red-800">Wake Word Error</h4>
  ...
  return (
    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-sm text-yellow-700">Initializing wake word detector...</span>
      </div>
    </div>
  );
};
