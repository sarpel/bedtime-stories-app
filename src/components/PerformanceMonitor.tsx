...
const PerformanceMonitor = ({ isOpen, onClose }: PerformanceMonitorProps) => {
  ...
  const refreshStats = () => {
    setPerformanceData({
      ...
      localStorageUsage: Math.floor(Math.random() * 20)
    });
  ...
  return (
    <div ref={panelRef} className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-2">
