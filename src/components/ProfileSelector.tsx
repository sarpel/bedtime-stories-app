...
const ProfileSelector: React.FC<ProfileSelectorProps> = ({ onProfileSelect, selectedProfileId }) => {
  const {
    profiles,
    activeProfile,
    isLoading,
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        {profile.age} yaş • {profile.gender === 'female' ? 'Kız' : profile.gender === 'male' ? 'Erkek' : 'Diğer'}
                      </div>
                    </div>
                  </div>
