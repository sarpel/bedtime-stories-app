    ...
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-4">
          This example demonstrates the new React-based Porcupine wake word
          implementation following the official Picovoice React documentation.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ol className="list-decimal list-inside text-sm text-blue-700 space-y-1">
          ...
          <li>
            Speak your command (e.g., "Create an adventure story about a
            princess")
          </li>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
          <li>
            <strong>Official React SDK:</strong> Uses @picovoice/porcupine-react
            hooks
          </li>
          <li>
            <strong>Automatic Audio Processing:</strong> Via
            @picovoice/web-voice-processor
          </li>
          <li>
            <strong>Better Error Handling:</strong> Platform compatibility
            checks
          </li>
          <li>
            <strong>Cleaner Code:</strong> Separation of concerns between wake
            word and STT
          </li>
          <li>
            <strong>React Hooks:</strong> Proper React state management
          </li>
        </ul>
      </div>
    </div>
