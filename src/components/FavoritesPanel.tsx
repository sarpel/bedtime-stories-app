...
import { Heart, Trash2, Volume2, Calendar, X } from "lucide-react";
            ...
            {favorites.length === 0 ? (
              <div className="text-center py-4">
                ...
                <p className="text-muted-foreground text-xs">
                  Masalları beğendiğinde kalp ikonuna tıklayarak favorilere
                  ekleyebilirsin
                </p>
              </div>
            ) : (
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center justify-between gap-1">
                          <div className="flex items-center gap-1 flex-1 min-w-0">
                            ...
                            >
                              {getStoryTypeName(
                                favorite.storyType || favorite.story_type || "",
                              )}
                            </Badge>
                            {(favorite.custom_topic ||
