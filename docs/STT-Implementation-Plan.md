...
_Bu doküman, Raspberry Pi Zero 2W masallar uygulamasına STT (Speech-to-Text) entegrasyonu için detaylı uygulama planını içerir._
...
_Bu plan, Raspberry Pi Zero 2W donanım sınırlamaları göz önünde bulundurularak hazırlanmıştır ve OpenAI Whisper API'sinin maliyet-performans avantajını öncelemektedir._
